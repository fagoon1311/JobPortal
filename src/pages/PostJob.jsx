...
const schema = z.object({
  ...
  company_id:z.string().min(1, {message: "Select or add a new company is required."}),
    ...
    <div>
      ...
      <form className='flex flex-col gap-4 p-4 pb-0' onSubmit={handleSubmit(onSubmit)}>
        ...
        <div className='flex gap-4 items-center'>
          ...
          {/* // only thing that is needed is fetch companies so that after new is uploaded it shows us all companues. */}
        </div>
        {
          errors.location && (
