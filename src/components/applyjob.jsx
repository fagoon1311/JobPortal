...
// so for forms and its validations we will be using react - hook - frms and zodd for validatoin.
// first we will create a schema for values to be validated.
        ...
        <DrawerTrigger asChild>
            ...
            <DrawerContent>
                ...
                className='flex flex-col gap-4 p-4 pb-0'>
                    ...
                    {/* // now since the radio group is a third party lib the register wont work here directly so we need this radio group inside controller provided by react hook */}
                    <Controller 
                    name='education' 
                    control={control} 
                    render={({ field }) =>(
