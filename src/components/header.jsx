...
const Header = () => {
  ...
  const handleOverlayClick = (e) =>{
    if(e.target === e.currentTarget){ // e.target: This refers to the actual element that was clicked.
      setShowSignIn(false)  // e.currentTarget: This refers to the element to which the event handler is attached. In this case, it's the div with the overlay.
      setSearch({})
    }
  }
  return (
